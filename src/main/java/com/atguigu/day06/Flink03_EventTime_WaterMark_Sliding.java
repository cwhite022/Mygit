 ...
 * @Version 1.0
 */
public class Flink03_EventTime_WaterMark_Sliding {
    public static void main(String[] args) throws Exception {
        ...
        //TODO 6. 开启一个基于事件时间滑动窗口，窗口大小为6s，滑动步长为3s
        WindowedStream<WaterSensor, Tuple, TimeWindow> window =
                keyedStream.window(SlidingEventTimeWindows.of(Time.seconds(6),Time.seconds(3)));
