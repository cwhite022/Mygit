...
//        sensorTable.where("id='1001'") 老版本
       ...
       // tableEnv.toDataStream(resultTable).print("toDataStream>>>>>."); 这两个流不支持表更新 追加流
       // tableEnv.toAppendStream(resultTable, Row.class).print("toAppendStream>>>>");
        //这两个流是撤回流 支持更新操作
        tableEnv.toChangelogStream(resultTable).print("toChangelogStream>>>>>>>.");
        tableEnv.toRetractStream(resultTable, Row.class).print("toRetractStream>>>>>>.");
