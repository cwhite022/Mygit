 ...
 * @Version 1.0
 */
public class Flink03_SQL_TumbleWindow {
    public static void main(String[] args) {
        ...
        tableEnv.sqlQuery("" +
                ...
                "    id, " +
                "    sum(vc), " +
                "    SESSION_START(pt, INTERVAL '10'SECOND) stt, " +
                "    SESSION_END(pt, INTERVAL '10'SECOND) ett " +
                "from sensor_pt " +
                "group by id, " +
        ...
        tableEnv.sqlQuery("" +
                ...
                "    id, " +
                "    sum(vc), " +
                "    SESSION_START(rt, INTERVAL '10'SECOND) stt, " +
                "    SESSION_END(rt, INTERVAL '10'SECOND) ett " +
                "from sensor_rt " +
                "group by id, " +
