 ...
 * @Version 1.0
 */
public class Flink10_SavePoint_CheckPoint {
    public static void main(String[] args) throws Exception {
        ...
        //设置状态后端
        env.setStateBackend(new FsStateBackend("hdfs://hadoop102:8020/flink0212/ck"));
        ...
        // TODO  当任务取消的时候不会删除CK生成的_metadata文件，这样就可以通过CK去恢复任务
